...
namespace Engine.Factories
{
    public class MapGenerator
    {
        public Map GenerateWorldEnvironment()
        {
            ...
            map.AddLocationToMap(0, 0, "Apartment", 
            ...
            map.AddLocationToMap(0, 1, "Yoyogi Park",
            ...
            map.AddLocationToMap(1, 0, "Shibuya Station",
            ...
            map.AddLocationToMap(1, -1, "Shibuya Underground",
            ...
            map.AddLocationToMap(0, -1, "Black Market",
            ...
            map.AddLocationToMap(-1, 0, "University",
            ...
            map.AddLocationToMap(-2, 0, "Museum",
